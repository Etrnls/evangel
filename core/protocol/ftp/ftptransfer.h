 ...
 ***************************************************************************/
#ifndef PROTOCOL_FTP_FTPTRANSFER_H
#define PROTOCOL_FTP_FTPTRANSFER_H
 ...
 */
class FTPTransfer : public AbstractTransfer
{
public:
	explicit FTPTransfer(const QString &URL) : URL(URL), reference(0), client(0) {}
